...
def chatroomcancer():
    #print("HELLLOOO THIS IS MY USER NAME", request.form['username'])
    return render_template('chatroomcancer.html', name = request.form['username'])#render_template('chatroomcancer.html')
...
if __name__ == "__main__":
    ...
    app.run(debug=True, host = '0.0.0.0', port=4000) #use localhost:8000